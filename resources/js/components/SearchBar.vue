    ...
    <div>
        ...
        <div class="relative z-10">
            ...
            <div v-if="focus" class="absolute bg-blue-900 text-white rounded-lg p-4 w-96 right-0 mr-6 mt-2 shadow z-20">
                ...
                <div v-for="result in results" :key="result.name" @click="focus = false">
...
<script>
    // using lodash stops the function hitting the db straight away in our case we are waiting 1 millisecond
